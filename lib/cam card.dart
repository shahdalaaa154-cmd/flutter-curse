...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Text(
    'Kandersteg, Switzerland',style: TextStyle(color: Colors.grey,),
  ),
    ],
  ),
   ),
    ...
    Widget textSection = Container(
      ...
      child: const Text(
        ...
        'Activities enjoyed here include rowing, and riding '
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: ListView(
          children: [
         Image.network('https://images.unsplash.com/photo-1500534623283-312aade485b7',
              width: 600,
              height: 240,
              fit: BoxFit.cover,
            ),
